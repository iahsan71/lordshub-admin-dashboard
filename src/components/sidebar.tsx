  ...
  const icons: Record<string, JSX.Element> = {
    LayoutDashboard: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25m0 0H5.25M7.5 10.875C7.5 10.254 8.004 9.75 8.625 9.75h2.25m0 0H9.75M15 10.875C15 10.254 15.504 9.75 16.125 9.75h2.25M19.125 12a.75.75 0 00-.75.75v2.25m0 0V21m0 0H3.75m16.5 0H21m0 0v-2.25m0-10.5a.75.75 0 00-.75-.75h-2.25M15 12.75h2.25" />
      </svg>
    ),
    Package: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    MessageSquare: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8h10M7 12h4m1 8l-4-2H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v12a2 2 0 01-2 2z" />
      </svg>
    ),
    Tag: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
